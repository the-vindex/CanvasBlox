...
vi.mock('@/components/level-editor/Toolbar', () => ({
  Toolbar: ({ onToolChange, onZoomIn, onZoomOut, onZoomReset, onTogglePropertiesPanel, editorState }: any) => (
    <div data-testid="toolbar">
      <button data-testid="tool-select" onClick={() => onToolChange('select')}>Select</button>
      <button data-testid="button-zoom-in" onClick={onZoomIn}>Zoom In</button>
      <button data-testid="button-zoom-out" onClick={onZoomOut}>Zoom Out</button>
      <button data-testid="button-reset-zoom" onClick={onZoomReset}>Reset Zoom</button>
      <button data-testid="button-toggle-properties" onClick={onTogglePropertiesPanel}>Toggle Properties</button>
