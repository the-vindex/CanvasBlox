...
export function LevelTabs({ levels, currentLevelIndex, onLevelSelect, onLevelClose, onNewLevel }: LevelTabsProps) {
    return (
        <div
            className="bg-card border-b border-border flex items-center px-4 overflow-x-auto scrollbar-custom h-10"
